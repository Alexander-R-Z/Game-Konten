...
<main>
    <div class="container">
        <form method="POST" action="assets/includes/home/login.inc.php" class="login-signup">
            ...
            <div class="form-group-login">
                ...
                <div class="alert alert-danger form-group-login"><?php echo $_SESSION['error']?></div>
                <?php
